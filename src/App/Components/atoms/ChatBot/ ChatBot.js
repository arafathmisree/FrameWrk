...
function ChatBotComp(props) {
        ...
        options: [
                   {
                     ...
                     label: "Yes",
                     trigger: () => {
                        props.clickEventHandler("tomato");
        ...
        options: [
                   {
                     ...
                     label: "Yes",
                     trigger: () => {
                        props.clickEventHandler("mushroom");
        ...
        options: [
                   {
                     ...
                     label: "Yes",
                     trigger: () => {
                        props.clickEventHandler("veggie");
                        return "Done"  
                      }
                   },
                   { 
  ...
  return <ChatBot steps={steps}  eventHandler={props.clickEventHandler}  {...config} />;
}
